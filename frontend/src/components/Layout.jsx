...
const navigation = [
  ...
  { name: 'Data Products', href: '/data-products', icon: DocumentTextIcon },
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:hidden">
        <div className="fixed inset-0 z-40 flex">
          ...
          {/* Sidebar */}
          <div
            className={`relative flex w-full max-w-xs flex-1 flex-col bg-white pt-5 pb-4 transition-transform duration-300 ease-in-out ${
          ...
          >
            ...
            <div className="flex flex-shrink-0 items-center px-4">
              <img
                ...
                alt="BankGen 360"
              />
              <span className="ml-2 text-xl font-semibold text-gray-900">BankGen 360</span>
            </div>
